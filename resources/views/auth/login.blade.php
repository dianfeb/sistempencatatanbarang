...
<head>
    ...
    <title>Login - Sistem Pencatatan Barang</title>
    <meta name="description" content="Login - Sistem Pencatatan Barang">
                    ...
                    <div class="hero-wrap d-flex align-items-center h-100">
                        ...
                        <div class="hero-content w-100 min-vh-100 d-flex flex-column">
                            ...
                            <div class="row g-0 my-auto">
                                <div class="col-11 col-sm-10 col-lg-9 mx-auto">
                                    <h1 class="text-11 text-white mb-4">{{ $greeting }},</h1>
                                    <p class="text-4 text-white lh-base mb-5">Selamat Datang di Sistem Pencatatan Barang</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container my-auto py-5">
                        <div class="row g-0">
                            <div class="col-11 col-sm-10 col-lg-9 col-xl-8 mx-auto">
                                <h3 class="fw-600 mb-4">{{ __('Login') }}</h3>
